...
Examples:
  python scripts/boolq_bench.py \
    --models Mostafa8Mehrabi/qwen3-30m-tinystories-final nickypro/tinyllama-42M HuggingFaceTB/SmolLM2-135M HuggingFaceTB/SmolLM2-360M Qwen/Qwen3-0.6B-Base Qwen/Qwen3-0.6B\
